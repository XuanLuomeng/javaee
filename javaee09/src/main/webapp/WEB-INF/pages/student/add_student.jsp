    ...
    <table width="500" border="0" cellspacing="1" cellpadding="0" bgcolor="#0099FF">
        ...
        <tr>
            ...
            <td align="left" valign="middle" bgcolor="#FFFFFF"><p>
                <label>
                    <input type="checkbox" name="courseList.cname" value="大学英语" id="courseName_0" />大学英语</label>
                    <input type="text" name="scores" value="0" id="courseScore_0" /></label>
                <br />
                <label>
                    <input type="checkbox" name="courseList.cname" value="高等数学" id="courseName_1" />高等数学</label>
                    <input type="text" name="scores" value="0" id="courseScore_1" /></label>
                <br />
                <label>
                    <input type="checkbox" name="courseList.cname" value="程序设计基础" id="courseName_2" />程序设计基础</label>
                    <input type="text" name="scores" value="0" id="courseScore_2" /></label>
                <br />
                <label>
                    <input type="checkbox" name="courseList.cname" value="计算机网络" id="courseName_3" />计算机网络</label>
                    <input type="text" name="scores" value="0" id="courseScore_3" /></label>
                <br />
            </p></td>
        </tr>
        <tr>
